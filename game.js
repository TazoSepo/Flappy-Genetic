// for the configuration of game modules
(function () {
	var timeouts = [];
...
var images = {};
// variable which controls the speed of the game
var speed = function (fps) {
	FPS = parseInt(fps);
}
// load images of the obstacles scene etc.
...
// Define the bird (parameters, size, etc.)
...
// To renew the scores and properties of the game
	...
	for (var i in this.birds) {
		if (this.birds[i].alive) {
			...
			if (this.birds[i].isDead(this.height, this.pipes)) {
				...
				this.alives--;
				Neuvol.networkScore(this.gen[i], this.score); // ქულის განახლება
				if (this.isItEnd()) {
					this.start();
				}
			}
...
// The condition to end the round
...
// visualise the prototype created
...
// Event handler, which load the game as soon as you enter the page
